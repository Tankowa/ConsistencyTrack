...
class Trainer:
    ...
    def after_iter(self):
        ...
        if (self.iter + 1) % self.exp.print_interval == 0:
            ...
            # record loss per print_interval
            self.tblogger.add_scalar("loss/loss_bbox", loss_meter["loss_bbox"].latest, self.iter + self.max_iter * self.epoch + 1)
            self.tblogger.add_scalar("loss/loss_giou", loss_meter["loss_giou"].latest, self.iter + self.max_iter * self.epoch + 1)
            self.tblogger.add_scalar("loss/loss_ce", loss_meter["loss_ce"].latest, self.iter + self.max_iter * self.epoch + 1)
            self.tblogger.add_scalar("loss/loss_total", loss_meter["total_loss"].latest, self.iter + self.max_iter * self.epoch + 1)
