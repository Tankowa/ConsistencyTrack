...
from yolox.tracker.consistency_tracker import ConsistencyTracker
...
class consistencyMOTEvaluator:
    ...
    def evaluate(
            ...
            with torch.no_grad():
                ...
                if frame_id == 1:
                    if len(seq_ids) != 0:
                        ...
                        seq_info_imgs=[]
                        seq_frame_ids=[]
                    tracker = ConsistencyTracker(model,tensor_type,self.confthre,self.detthre,self.nmsthre3d,self.nmsthre2d,self.association_interval)
        ...
        print("consistency track fps : {}".format(n_samples*2/track_time))
