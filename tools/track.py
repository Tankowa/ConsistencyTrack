...
from yolox.evaluators import consistencyMOTEvaluatorKL
...
def make_parser():
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="exps/example/mot/yolox_x_consistency_track_dancetrack.py",
        type=str,
    ...
    parser.add_argument("-c", "--ckpt", default="consistencytrack_dancetrack.pth.tar", type=str, help="ckpt for eval")
...
def main(exp, args, num_gpu):
    ...
    evaluator = consistencyMOTEvaluatorKL(
        args=args,
    ...
    *_, summary = evaluator.evaluate(
    ...
    if args.mot20:
        ...
        gtfiles = glob.glob(os.path.join('datasets/dancetrack/train', '*/gt/gt{}.txt'.format(gt_type)))
